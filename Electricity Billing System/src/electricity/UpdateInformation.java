...
public class UpdateInformation extends JFrame implements ActionListener {
    ...
    // Constructor for UpdateInformation class
    UpdateInformation(String meter) {
        ...
        // Adding heading JLabel
        JLabel heading = new JLabel("UPDATE CUSTOMER INFORMATION");
        heading.setBounds(110, 0, 400, 30);
        heading.setFont(new Font("Tahoma", Font.PLAIN, 20));
        add(heading);

        // Labels and TextFields for displaying and updating customer information
        ...
        // Fetching existing customer information from the database
        try {
            Conn c = new Conn();
        ...
        // Buttons for updating information and canceling the operation
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == update) {
            // Retrieving updated information from TextFields
    ...
    // Main method to create an instance of UpdateInformation class
